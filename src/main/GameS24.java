...
public class GameS24 extends GameBase 
{
	...
	{	
		...
		items.add(new Potion("Health", 2657, 2081));
		items.add(new Potion("Health", 2068, 1180));
		items.add(new Potion("Health", 3084, 1168));
		items.add(new Potion("Health", 1306,  518));
		items.add(new Potion("Health", 4650, 2445));
		
		items.add(new Potion("Immunity", 736, 2081));
		items.add(new Potion("Immunity", 402,  595));
		items.add(new Potion("Immunity", 4663, 734));
